...
Bk.capitalize = function (str) {
  return str.charAt(0).toUpperCase() + str.slice(1);
}

Bk.insertArray = function (array, index, item) {
  return array.splice(index, 0, item);
}

Bk.getTime = function (date) {
  if (date === undefined) {
    date = new Date();
  } else {
    date = new Date(date);
...
Bk.getTimeDiffWithNow = function (dateStr, TimeStr) {
