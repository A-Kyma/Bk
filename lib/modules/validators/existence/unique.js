...
Validator.create({
    ...
    async isValid({ doc,param,name,value }) { // arg contains className, doc, name, nestedName, value, param, validator
        let selector={}
        selector[name] = value
        ...
        return await !doc.constructor.getCollection().findOneAsync(selector)
    },
