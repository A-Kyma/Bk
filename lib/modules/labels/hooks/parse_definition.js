...
function onParseDefinition(parsedDefinition, definition, className) {
	...
	if (definition.fields) {
      ...
      parsedDefinition[fieldName] = {};
        ...
        if (!Match.test(fieldDefinition.label, String) && fieldDefinition.label !== undefined) {
          throwParseError([{
            'class': className
          }, {
            'field': fieldName
      ...
      if (_has(fieldDefinition,"placeholder")) {
        if (!Match.test(fieldDefinition.placeholder, String) && fieldDefinition.placeholder !== undefined) {
          throwParseError([{
            'class': className
          }, {
            'field': fieldName
