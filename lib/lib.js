...
// Import Class from Astronomy to re-export it for convenience
import { Class } from "meteor/akyma:astronomy";

// Some custom fields types
import {
  Color, DateTime, Domain, Email, Enum, Amount, Avatar, Image, Integer, Languages,
  Password, Textarea, TextEditor, Time, TrimmedString, Percentage, Phone, Url, Variant, Rating, Hex
...
import {Device} from "./classes/device"  // Must be imported before User (User has a devices field)
import Meta from "./classes/meta";
import {User,UserProfile} from "./classes/user";
import Statistic from "./classes/statistics";

// Add devices field to UserProfile after Device class is created to avoid circular dependency
UserProfile.extend({
  fields: {
...
import XlsExportColumnParam from "./classes/XlsExportColumnParam";
import XlsExportTreatment from "./utils/XlsExportTreatment";
...
export {
  ...
  UserProfile,
  Variant,
  XlsExportColumnParam,
  XlsExportColumnTypes,
  XlsExportTreatment
}