...
//     Implementation of Skip and Limit
      ...
      array = _.slice(this.array,(this.page - 1) * this.perPage, this.page * this.perPage)
 ...
 ***/
  Datatable.publish = (subscriptionName, collection, fields, isPublic, restrictionFunction) => Meteor.publish(subscriptionName, function(selector,options) {
    ...
    const restriction = (restrictionFunction && restrictionFunction.call({selector,options,userId:this.userId})) || {};
