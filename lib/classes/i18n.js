...
I18n.getCollection().find().observe({
  added(doc) { return I18n._translations[doc.locale + "." + doc.key] = doc.text; },
  changed(doc) { return I18n._translations[doc.locale + "." + doc.key] = doc.text; },
  removed(doc) { return delete I18n._translations[doc.locale + "." + doc.key]; }
});
